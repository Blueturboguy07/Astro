...
import { CATALOG_ROWS, availableRows, ResolvedRow } from '../../../../lib/simplicity/models/catalog';
import { ModelWithProvider, MinimalProvider } from '../../../../lib/simplicity/models/types';
import SearchAgent from '../../../../lib/simplicity/agents/search';
import CouncilAgent from '../../../../lib/simplicity/agents/council';
import {
  autoPickCouncil,
  canRunCouncil,
  pickChair,
} from '../../../../lib/simplicity/agents/council/select';
import SessionManager from '../../../../lib/simplicity/session';
import { ChatTurnMessage } from '../../../../lib/simplicity/types';
import { CouncilMemberSpec, SearchSources } from '../../../../lib/simplicity/agents/search/types';
import db from '../../../../lib/simplicity/db';
import { and, eq } from 'drizzle-orm';
import { chats, messages as messagesSchema } from '../../../../lib/simplicity/db/schema';
import UploadManager from '../../../../lib/simplicity/uploads/manager';
import { UsageMeter, LLMUsage } from '../../../../lib/simplicity/pricing/meter';
