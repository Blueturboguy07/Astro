...
import { getMeasurementUnit } from '@/lib/simplicity/config/clientRegistry'
...
const Weather = ({
  ...
  if (!current || !daily?.time || daily.time.length === 0) {
    return (
      <div className="relative overflow-hidden rounded-lg bg-gray-200 shadow-md dark:bg-gray-800">
  ...
  return (
    <div className="relative overflow-hidden rounded-lg shadow-md">
      ...
      <div className="relative p-4 text-gray-800 dark:text-white">
        <div className="mb-3 flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 font-medium text-sm drop-shadow">
        ...
        <div className="mb-3 border-gray-800/20 border-b pb-3 dark:border-white/20">
          <h3 className="font-semibold text-base drop-shadow-md">{location}</h3>
          <p className="mt-0.5 text-gray-700 text-xs drop-shadow dark:text-white/80">
        ...
        <div className="mb-3 grid grid-cols-6 gap-2 border-gray-800/20 border-b pb-3 dark:border-white/20">
          {forecast.map((day, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center rounded-md bg-gray-800/10 p-2 backdrop-blur-sm dark:bg-white/10"
            >
              <p className="mb-1 font-medium text-xs">{day.day}</p>
              <img
              ...
              {day.precipitation > 0 && (
                <div className="mt-1 flex items-center gap-0.5">
                  <Droplets className="h-3 w-3 text-gray-600 dark:text-white/70" />
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          <div className="flex items-center gap-2 rounded-md bg-gray-800/10 p-2 backdrop-blur-sm dark:bg-white/10">
            <Wind className="h-4 w-4 flex-shrink-0 text-gray-700 dark:text-white/80" />
            <div>
          ...
          <div className="flex items-center gap-2 rounded-md bg-gray-800/10 p-2 backdrop-blur-sm dark:bg-white/10">
            <Droplets className="h-4 w-4 flex-shrink-0 text-gray-700 dark:text-white/80" />
            <div>
              <p className="text-[10px] text-gray-600 dark:text-white/70">
                Humidity
              </p>
          ...
          <div className="flex items-center gap-2 rounded-md bg-gray-800/10 p-2 backdrop-blur-sm dark:bg-white/10">
            <Gauge className="h-4 w-4 flex-shrink-0 text-gray-700 dark:text-white/80" />
            <div>
              <p className="text-[10px] text-gray-600 dark:text-white/70">
                Feels Like
              </p>
