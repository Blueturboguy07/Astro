...
import SmallNewsCard from '@/screens/simplicity/Discover/SmallNewsCard';
import MajorNewsCard from '@/screens/simplicity/Discover/MajorNewsCard';
...
const DiscoverPage = () => {
  ...
  const fetchArticles = async (topic: string) => {
    setLoading(true);
    try {
      const res = await apiFetch(`/api/discover?topic=${topic}`, {
        method: 'GET',
        headers: {
